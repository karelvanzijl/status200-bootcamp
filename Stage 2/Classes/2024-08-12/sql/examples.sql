...
-- Retrieve all customer information for customers living in Berlin or Madrid
SELECT * 
FROM customer 
WHERE cust_city IN ('Berlin', 'Madrid');

-- Retrieve the name of the customer and the date of the order 
-- for all customers living in London, Berlin, or Madrid
SELECT 
    customer.cust_name AS customerName,
    orders.order_date AS orderDate
FROM customer
JOIN orders ON orders.cust_id = customer.cust_id
WHERE cust_city IN ('Berlin', 'Madrid', 'London');

-- Retrieve the customer name and the name of the products they ordered
SELECT 
    customer.cust_name AS customerName,
...
JOIN product ON product.prod_id = orderdetail.prod_id;
